...
public class ShadowTests {
	...
	public void sphereTriangleChangeTriangle1() {
		...
		Render render = new Render(). //
				setImageWriter(new ImageWriter("sphereTriangleChangingTriangle1", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
	...
	public void sphereTriangleChangeTriangle2() {
		scene.geometries.add( //
				new Sphere(new Point3D(0, 0, -200), 60) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)), //
				new Triangle(new Point3D(-50, -20, 9), new Point3D(-20, -50, 9), new Point3D(-48, -48, 5)) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)) //
		);
		scene.lights.add( //
		...
		Render render = new Render(). //
				setImageWriter(new ImageWriter("sphereTriangleChangingTriangle2", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
	...
	public void sphereTriangleChangeLight1() {
		...
		Render render = new Render(). //
				setImageWriter(new ImageWriter("sphereTriangleChangingLight1", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
	...
	public void sphereTriangleChangeLight2() {
		...
		Render render = new Render(). //
				setImageWriter(new ImageWriter("sphereTriangleChangingLight2", 400, 400)) //
				.setCamera(camera) //
				.setRayTracer(new RayTracerBasic(scene));
		render.renderImage();
		render.writeToImage();
