...
public class LightsTests {
	...
	private Camera camera1 = new Camera(new Camera.BuilderCamera(new Point3D(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0))) //
			.setViewPlaneSize(150, 150) //
			.setDistance(1000);
	private Camera camera2 = new Camera(new Camera.BuilderCamera(new Point3D(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0))) //
	 ...
	 */
	@Test
	public void sphereDirectionalTest() {
	 ...
	 */
	@Test
	public void trianglesDirectionalTest() {
	 ...
	 */
	@Test
	public void trianglesPointTest() {
